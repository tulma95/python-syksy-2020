...
### Pipenv-projektin alustus

Harjoitustyössä tehtävä ohjelmistossa hyödynnetään [pipenv](https://pipenv.pypa.io/en/latest/)-työkalua. Pipenvin asennukseen ja projektin alustamiseen löydät ohjeet [täältä](./pipenv.md).
